...
<html class="no-js" lang="en">
  ...
  <title><?php echo "Federal Register - ".$title;?></title>
  ...
  <?php 
    ...
    echo link_tag('assets/css/dq-datepicker.css');
  ?>
...
<script src="<?php echo base_url("assets/js/dq-datepicker.js"); ?>"></script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
<script type="text/javascript">
var buttonImageFile = "https://dequeuniversity.com/assets/images/calendar.png";
</script>
  
<!-- Scripts for the dropdown megamenu and flexslider -->
...
<div class="row top-header" role="banner">
    <div class="large-6 columns"> <a href="<?php echo $dol_home; ?>" class="left"> <span class="brand"></span>
      <h1 class="header-logo-type">UNITED STATES <br>
        DEPARTMENT OF LABOR </h1>
      </a> </div>
    <div class="large-2 columns">
      <div class="social-block right hide-for-small"> 
      <a href="//www.dol.gov/cgi-bin/leave-dol.asp?exiturl=http://www.facebook.com/departmentoflabor&exitTitle=www.Facebook.com&fedpage=no"  class="sm-facebook">Facebook</a> 
      <a href="//www.dol.gov/cgi-bin/leave-dol.asp?exiturl=http://twitter.com/usdol&exitTitle=www.Twitter.com&fedpage=no" class="sm-twitter">Twitter</a> 
      <a href="//www.dol.gov/cgi-bin/leave-dol.asp?exiturl=http://www.instagram.com/USDOL&exitTitle=www.instagram.com/USDOL&fedpage=no" class="sm-instagram">DOL Instagram</a> 
      <a href="//www.dol.gov/rss/" class="sm-rss">RSS</a> 
    ...
    <div class="large-4 columns">
      <div id="searchbox">
        <form accept-charset="UTF-8" action="http://search.usa.gov/search" id="search_form" method="get" class="search"><input name="utf8" type="hidden" value="&#x2713;" />
          <div class="small-10 columns">
              <label for="query">Search</label>
              <input type="search" name="query" id="query" placeholder="Find it in DOL" title="Find it in DOL" required="required" >
          </div>
          <div class="small-2 columns">
              <input type="hidden" name="affiliate" value="u.s.departmentoflabor">
              <input type="image"  src="//www.dol.gov/homepage/img/icon-search.png"  vspace="4"  alt="Search DOL" class="usagov-submit">
          </div>
        </form>
      </div>
    </div>
